                        ...
                        <div class="grid-content bg-purple">
                            <el-form :label-position="labelPosition" label-width="80px" :model="form">
                                <el-form-item label="名称" >
                                    <el-input v-model="form.name" placeholder="请输入数据集名称" clearable prefix-icon="el-icon-search"></el-input>
                                </el-form-item>
                            </el-form>
                        </div>
                    </el-col>
                            ...
                            <el-form :label-position="labelPosition" label-width="80px" :model="form">
                                <el-form-item label="状态">
                                  <el-select v-model="form.pname" placeholder="请选择处理状态">
                                    <el-option label="成功" value="first"></el-option>
                                    <el-option label="失败" value="second"></el-option>
                                  </el-select>
                                </el-form-item>
                            </el-form>
                        </div>
